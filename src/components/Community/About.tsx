...
import { Image, Text, Box, Flex, Icon, Stack, Divider, Link, Button, Spinner } from '@chakra-ui/react';
            ...
            <Flex
                ...
                <Stack>
                    ...
                    <Link href={`/r/${communityData.id}/submit`}>
                            <Button width='100%' alignSelf='center' height='30px'>Create Post</Button>
                    </Link>
                        ...
                        <>
                            ...
                            <Stack spacing={1} fontSize='10pt'>
                                ...
                                <Flex justify='center'>
                                    {selectedFile && (
                                        (uploadingImage ?
                                            <Spinner /> : <Text cursor='pointer' onClick={onUpdateImage}>Save Changes</Text>
                                        ))
                                    }
                                </Flex>
                                <input
